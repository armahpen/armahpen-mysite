  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Heart Icon */}
        <div className="animate-fadeInUp delay-200 icon-3d icon-gradient" style={{ cursor: 'pointer' }}>
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M30 35h15M52 35h13M30 45h10M65 45h10M35 55h8M70 55h8" 
                  ...
                  strokeWidth="1.5"/>
            <circle cx="40" cy="25" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="80" cy="25" r="3" fill="rgba(255, 255, 255, 0.7)"/>
          </svg>
        </div>

        {/* Brain Icon */}
        <div className="animate-fadeInUp delay-300 icon-3d icon-gradient" style={{ cursor: 'pointer' }}>
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <circle cx="75" cy="45" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="45" cy="65" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="75" cy="65" r="3" fill="rgba(255, 255, 255, 0.7)"/>
          </svg>
        </div>

        {/* Hand Icon */}
        <div className="animate-fadeInUp delay-400 icon-3d icon-gradient" style={{ cursor: 'pointer' }}>
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              ...
              <radialGradient id="handFill" cx="50%" cy="50%">
            ...
            <path d="M50 35h6M66 25h6M82 30h6M98 40h6" 
                  stroke="rgba(255, 255, 255, 0.6)" 
                  strokeWidth="1.5"/>
            <circle cx="53" cy="25" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="69" cy="20" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="85" cy="25" r="3" fill="rgba(255, 255, 255, 0.7)"/>
            <circle cx="101" cy="35" r="3" fill="rgba(255, 255, 255, 0.7)"/>
          </svg>
        </div>
      </div>
