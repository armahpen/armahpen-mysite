  ...
  return (
    <div style={{
      ...
      <div className={`mobile-nav-overlay ${mobileMenuOpen ? 'active' : ''}`}>
        ...
        <Link href="/experience" onClick={() => setMobileMenuOpen(false)} style={{color: 'white', textDecoration: 'none', fontSize: '1.2rem', fontWeight: '500', padding: '0.75rem 0'}}>Experience</Link>
